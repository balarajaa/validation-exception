package com.learning.validation.exception.service;
...
import com.learning.validation.exception.repository.UserRepository;
...
public class UserService {
    ...
    public User getUser(int id) throws UserNotFoundException {
        ...
        if (user != null) {
            ...
            throw new UserNotFoundException("user not found with the user id :"+id);
        }
    }
}
